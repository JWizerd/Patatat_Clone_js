var soundKeyQ = new Howl({
  urls: ['sounds/bubbles.mp3']
});
var soundKeyP = new Howl({
  urls: ['sounds/clay.mp3']
});
var soundKeyElse = new Howl({
...
var circles = [];
    ...
    if(Keys[event.key]){
      // Circle is generated at random point on screen
    ...
    function onFrame(event) {
      // save circles into array for adding sound
